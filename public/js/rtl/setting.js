...
!function (a) {
    ...
    a.magnificPopup.registerModule("zoom", {
        options: {
            ...
            initZoom: function () {
                ...
                return O() ? h["-moz-transform"] = h.transform = "translate(" + e.right + "px," + e.top + "px)" : (h.right = e.right, h.top = e.top), h
            }
        }
    });
    ...
    a.magnificPopup.registerModule("gallery", {
        options: {
            ...
            arrows: !0,
            tPrev: "Previous (Right arrow key)",
            ...
            initGallery: function () {
                ...
                return b.direction = !0, c && c.enabled ? (f += " mfp-gallery", w(m + e, function () {
                    ...
                    if (b.items.length > 1 && c.arrows && !b.arrowRight) {
                        var d = c.arrowMarkup,
                    ...
                    d.off(e), b.wrap.off("click" + e), b.arrowRight = b.arrowRight = null
                })) : !1
            }, next: function () {
...
!function (t, e, i) {
    ...
    t.HoverDir = function (e, i) {
        ...
        _init: function (e) {
            ...
            var i = t.width(), o = t.height(), n = (e.x - t.offset().right - i / 2) * (i > o ? o / i : 1),
                s = (e.y - t.offset().top - o / 2) * (o > i ? i / o : 1);
            return Math.round((Math.atan2(s, n) * (180 / Math.PI) + 180) / 90 + 3) % 4
        }, _getStyle: function (t) {
            var e, i, o = {right: "0px", top: "-100%"}, n = {right: "0px", top: "100%"},
                s = {right: "-100%", top: "0px"}, r = {right: "100%", top: "0px"}, a = {top: "0px"}, p = {right: "0px"};
            switch (t) {
                case 0:
...
;window.Modernizr = function (a, b, c) {
    ...
    B = function (a) {
        ...
        function g(a, e, f, g, h) {
            ...
            i.url.split(".").pop().split("?").shift(), i.bypass || (e && (e = d(e) ? e : e[a] || e[g] || e[a.split("https://iqonicthemes.com/").pop().split("?")[0]]), i.instead ? i.instead(a, e, f, g, h) : (y[i.url] ? i.noexec = !0 : y[i.url] = 1, f.load(i.url, i.forceCSS || !i.forceJS && "css" == i.url.split(".").pop().split("?").shift() ? "c" : c, i.noexec, i.attrs, i.timeout), (d(e) || d(j)) && f.load(function () {
