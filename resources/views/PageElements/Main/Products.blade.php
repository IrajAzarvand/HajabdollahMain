    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                ...
                <div class="mr-masonry mr-columns-3" id="ProductsSection">
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                function createElementdiv(obj) {
                    ...
                    div_obj.setAttribute("id", "productDiv")
                    productsSection.appendChild(div_obj);

                    // Create second div inside productDiv
                    ...
                    images_popup_link.setAttribute("class", "image-link popup-img")
                ...
                data.forEach(function(entry){
                    ...
                    createElementdiv("ProductsSection");
