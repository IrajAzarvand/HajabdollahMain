...
{{--                                    <ul class="marv-portfolio-icon">--}}
{{--                                        <li><a href="#"><i class="fa fa-link"></i></a></li>--}}
{{--                                        <li><a class="image-link popup-img" href="images/portfolio/05.jpg"><i--}}
{{--                                                    class="fa fa-arrows-alt"></i></a></li>--}}
{{--                                    </ul>--}}
{{--                                </div>--}}
{{--                            </div>--}}
...
{{--                                    <ul class="marv-portfolio-icon">--}}
{{--                                        <li><a href="#"><i class="fa fa-link"></i></a></li>--}}
{{--                                        <li><a class="image-link popup-img" href="images/portfolio/06.jpg"><i--}}
{{--                                                    class="fa fa-arrows-alt"></i></a></li>--}}
{{--                                    </ul>--}}
{{--                                </div>--}}
{{--                            </div>--}}
...
{{--                                    <ul class="marv-portfolio-icon">--}}
{{--                                        <li><a href="#"><i class="fa fa-link"></i></a></li>--}}
{{--                                        <li><a class="image-link popup-img" href="images/portfolio/07.jpg"><i--}}
{{--                                                    class="fa fa-arrows-alt"></i></a></li>--}}
{{--                                    </ul>--}}
{{--                                </div>--}}
{{--                            </div>--}}
